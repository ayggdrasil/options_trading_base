                ...
                content: [
                    {
                        ...
                        text: JSON.stringify({
                            ...
                            approval_target: CONFIG.CONTRACTS.POSITION_MANAGER,
                            approval_token: CONFIG.CONTRACTS.USDC,
                            instruction: "Ensure you have approved 'approval_token' (USDC) for 'approval_target' (PositionManager) to spend amount >= 'amount'"
                        }, null, 2),
                    },
                ],
            };
