import Safe, { AddOwnerTxParams, AddPasskeyOwnerTxParams, RemoveOwnerTxParams, RemovePasskeyOwnerTxParams, SwapOwnerTxParams } from '@safe-global/protocol-kit';
...
export declare class BaseClient {
     ...
     */
    createAddOwnerTransaction(addOwnerParams: AddOwnerTxParams | AddPasskeyOwnerTxParams): Promise<TransactionBase>;
    /**
     ...
     * @returns {TransactionBase} The encoded data
     */
    createRemoveOwnerTransaction(removeOwnerParams: RemoveOwnerTxParams | RemovePasskeyOwnerTxParams): Promise<TransactionBase>;
    /**
