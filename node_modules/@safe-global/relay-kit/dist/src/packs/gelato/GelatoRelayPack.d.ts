...
import { GelatoCreateTransactionProps, GelatoEstimateFeeProps, GelatoEstimateFeeResult, GelatoExecuteTransactionProps, GelatoOptions } from './types';
export declare class GelatoRelayPack extends RelayKitBasePack<{
     ...
     */
    createRelayedTransaction({ transactions, onlyCalls, options }: GelatoCreateTransactionProps): Promise<SafeTransaction>;
    /**
     ...
     */
    createTransaction({ transactions, onlyCalls, options }: GelatoCreateTransactionProps): Promise<SafeTransaction>;
    /**
