import { EstimateGasData, SafeOperation, SafeSignature, SafeUserOperation, UserOperation } from '@safe-global/types-kit';
...
declare class EthSafeOperation implements SafeOperation {
    ...
    moduleAddress: string;
    chainId: bigint;
    constructor(userOperation: UserOperation, { chainId, entryPoint, validAfter, validUntil, moduleAddress }: SafeOperationOptions);
