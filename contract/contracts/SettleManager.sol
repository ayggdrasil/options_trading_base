...
contract SettleManager is BasePositionManager, ISettleManager, IERC1155Receiver, OwnableUpgradeable {
    ...
    function settlePosition(
        ...
        return _settlePosition(_path, _underlyingAssetIndex, _optionTokenId, _minOutWhenSwap, _withdrawNAT);
    }
    ...
    function settlePositions(
        ...
        for (uint256 i = 0; i < length;) {
            _settlePosition(_paths[i], _underlyingAssetIndex, _optionTokenIds[i], _minOutWhenSwaps[i], _withdrawNAT);
            unchecked { i++; }
        }
    }
