...
const SelectedOptionDetail: React.FC<SelectedOptionDetail> = ({
  ...
  const [isSlippageDetailsOpen, setIsSlippageDetailsOpen] =
            ...
            <div className="flex flex-row items-center justify-between h-[14px] w-full">
              <div className="flex flex-row items-center gap-[8px]">
                <img
                  ...
                  src={IconSelectedOptionDetailPlus}
                />
                <p className="h-[14px] text-[12px] text-gray80 font-semibold leading-3">
                  Mark Price
                </p>
              </div>
              <div>
            ...
            <div className="flex flex-row items-center justify-between h-[22px] min-h-[22px] w-full mt-[2px]">
              <div className="flex flex-row items-center gap-[8px]">
                {selectedOrderSide === "Buy" ? (
                  ...
                  <img
                    className="w-[14px] h-[14px]"
                    src={IconSelectedOptionDetailMinus}
                  />
                )}
                <WithTooltip
                  tooltipContent={
                    ...
                    >
                      The mechanism that penalizes trades adding to the
                      platform’s Greeks exposure and rewards trades that reduce
                      it.
                    </p>
                  }
          ...
          <div className="relative group cursor-help w-fit h-full font-semibold">
            ...
            >
              <p className="text-[12px] text-gray80 leading-[0.85rem]">
                Trade Fee is{" "}
                <span className="text-gray98 font-bold">0.03%</span> of the
                notional volume for all trades,
                <br />
                except <span className="text-gray98 font-bold">0.06%</span> for
                buying naked options, not exceeding
                <br />
                <span className="text-gray98 font-bold">12.5%</span> of
          ...
          <div className="flex flex-col mt-[4px] gap-[16px]">
            <div className="flex flex-row justify-between items-center h-fit px-[18px]">
                ...
                {slippageValues.map((value, index) => (
                  <button
                    ...
                    className={twJoin(
                      ...
                      slippage === value
                        ? "h-[12px] text-[#E6FC8D] bg-black29 font-bold"
                        : "h-full text-gray80 font-normal"
                    )}
                    onClick={() => {
              ...
              <div className="flex flex-row justify-between items-center w-[125px] h-[34px] px-[12px] py-[4px] rounded-[4px] bg-black29">
                ...
                />
                <div>
                  <p className="ml-[4px] text-[10px] text-[#525252] font-semibold">
                    %
                  </p>
                </div>
              </div>
            ...
            <div className="flex flex-col px-[18px] gap-[4px]">
              <p className="text-[12px] font-semibold text-greene6">
                Why this number?
              </p>
              <p className="text-[12px] text-[#666666] mt-[2px]">
                Moby calculates real-time prices based on Synchronized Liquidity
                Engine (SLE). Accordingly, prices may be updated during trade
                execution.
              </p>
              <p className="text-[12px] text-[#666666]">
                The configured tolerance is set to facilitate trade execution,
